 ...
 */
 ...
 //                inputFile.accept=type.join(",");
   ...
   executeUpload(){
     ...
     else MiscUtils.Toast.show("You didn't select a file");
   ...
   _filesSelectedHandler(e){
     ...
     if(options==null && this.manualUpload!=true){
         MiscUtils.Toast.show("Error. Verify your files");
   ...
   /*  var type=options.fileTypes;
     ...
     if(e.target.files && e.target.files[0]){
       ...
       if(this.photo && this.crop){
         MiscUtils.Dialog.createAndShow({element:"photo-cropper-dialog",params:[e.target.files[0],function(blob){
         ...
         if(!context.manualUpload){
           ...
           MiscUtils.Toast.show("You didn't select any file");
       }
   }
